...
OUTPUT_FILE = "results/qwen3_clean_native_results.jsonl"
...
def main():
    ...
    print("▶️ Start evaluation (Native PyTorch)...")
    ...
    print(f"Please run score file: python run_realworldqa.py eval --data-dir ./data --input-file {OUTPUT_FILE} --output-file results/clean_score.csv")
