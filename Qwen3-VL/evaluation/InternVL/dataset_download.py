...
argparser.add_argument("--dataset_names", default="AerialMaritimeDrone,Aquarium,CottontailRabbits,EgoHands,NorthAmericaMushrooms,Packages,PascalVOC,pistols,pothole,Raccoon,ShellfishOpenImages,thermalDogsAndPeople,VehiclesOpenImages", type=str) # "all" or names joined by comma
argparser.add_argument("--dataset_path", default="/home/zirui/Qwen3-VL/data/odinw", type=str)
